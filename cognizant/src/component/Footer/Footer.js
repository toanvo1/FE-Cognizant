      ...
      <div className="container-inner">
        ...
        <div className="form-grid">
          <div className="form-column">
            ...
            <div className="form-group">
              <input type="tel" name="phoneNumber" placeholder="+84 3345 9145" required />
            </div>
            <div className="form-group">
          ...
          <div className="form-column">
            <div className="form-group">
              <input
                type="text" name="companyName" placeholder="Nhập tên công ty" required
                />
            </div>
            <div className="form-group">
              <input
                type="text"name="position"placeholder="Nhập chức danh"required
              />
            </div>
            <div className="form-group">
              <select
